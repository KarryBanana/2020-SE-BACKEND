    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywordstr', models.TextField(default='', max_length=20000)),
                ('authornamestr', models.TextField(default='', max_length=20000)),
                ('field', models.CharField(default='', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.author')),
            ],
        ),
        migrations.CreateModel(
            name='Venue',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paper', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.paper')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.user')),
            ],
        ),
        migrations.CreateModel(
            name='AuthorOrg',
